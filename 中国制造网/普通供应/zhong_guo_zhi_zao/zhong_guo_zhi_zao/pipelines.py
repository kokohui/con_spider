...
class ZhongGuoZhiZaoPipeline(object):
    ...
    def close_spider(self, spider):
        sql_id = "SELECT id FROM bus_spider_data WHERE source = '中国制造网' and  TYPE = 'gongying' AND is_del = '0' AND isuse = '0' ORDER BY create_date LIMIT 1 "
