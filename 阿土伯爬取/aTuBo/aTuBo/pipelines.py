        ...
        if result_count == 0:
            ...
            try:
                ...
                data = self.cur.execute(sql_in, (
                    ...
                    '43e9737882af413095f612ef34412a8f', item['one_class_name'], item['one_class_id'], item['two_class_name'], item['two_class_id'], item['tree_class_name'], item['tree_class_id']))  # 单条插入
                print('.......................................')
                print('data', data)
