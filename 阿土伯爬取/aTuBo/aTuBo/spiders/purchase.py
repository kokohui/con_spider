...
class PurchaseSpider(scrapy.Spider):
    ...
    def parse_1(self, response):
        ...
        print(res_pro_list_url)
        for res_pro_url in res_pro_list_url:
            res_pro_url = res_pro_url.extract()
            # tree_class_id = res_pro_url.split('/')[-1].strip('.html')
            # item['tree_class_id'] = tree_class_id
    ...
    #
    #     yield Request(url='http://www.atobo.com/Buys/11293782.html', callback=self.parse_2)
