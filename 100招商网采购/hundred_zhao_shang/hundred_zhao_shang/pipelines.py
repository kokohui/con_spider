...
class HundredZhaoShangPipeline(object):
    ...
    def close_spider(self, spider):
        # sql_id = "SELECT id FROM bus_spider_data WHERE source = '100招商网' and TYPE = 'caigou' AND is_del = '0' AND isuse = '0' ORDER BY create_date LIMIT 1 "
