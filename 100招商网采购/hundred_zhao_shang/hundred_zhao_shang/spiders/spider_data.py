...
class SpiderDataSpider(scrapy.Spider):
    name = 'spider_data'
    # start_urls = ['http://www.zhaoshang100.com/qb-22/']

    def start_requests(self):
        sql_id = "SELECT url FROM bus_spider_data WHERE source = '100招商网' and TYPE = 'caigou' AND is_del = '0' AND isuse = '0' ORDER BY create_date LIMIT 1 "
        cur.execute(sql_id)
